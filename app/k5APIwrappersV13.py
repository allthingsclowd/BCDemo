...
# def create_server(k5token, server_id, project_id, region):
#     """Summary - list  K5 projects
...
def list_keypairs(k5token, project_id, region):
    ...
    try:
        ...
        return 'Failed to list ssh key pairs'

def show_keypair_detail(k5token, project_id, keypair_name, region):
    ...
    try:
        ...
        return 'Failed to show ssh key pair details'


def delete_keypair(k5token, project_id, keypair_name, region):
    """Summary - show  K5 project keypair details
    ...
    try:
        ...
        return 'Failed to delete ssh key pair'
...
def create_keypair(k5token, keypair_name, project_id, az, region):
    ...
    try:
        ...
        return 'Failed to create ssh key pair'
...
def delete_network_connector_id(k5token, connector_id, region):
    """Summary
...
def list_security_groups(adminUser, adminPassword, project, contract, region):
    """Summary
    ...
    # get a regional domain scoped token to make queries to facilitate
    # conversion of object names to ids
    k5token = get_project_scoped_token(
        adminUser, adminPassword, project, contract, region)
    connectorURL = 'https://networking.' + region + \
...
def show_security_group(adminUser, adminPassword, project, sg_id, contract, region):
    """Summary
...
def delete_security_group(adminUser, adminPassword, project, sg_id, contract, region):
    """Summary
...
def get_router_details(k5token, routerid, region):
    """Summary
...
def show_ipsec_policies(adminUser, adminPassword, project, contract, region):
    """Summary
...
def show_ipsec_policy_detail(adminUser, adminPassword, project, policy_id, contract, region):
    """Summary
...
def create_ipsec_policy(adminUser, adminPassword, project, ipsecname, protocol, auth_alg, mode, azone, contract, region):
    """Summary
...
def update_ipsec_policy(adminUser, adminPassword, project, ipsecname, protocol, auth_alg, mode, azone, contract, region):
    """Summary
...
def delete_ipsec_policy_detail(adminUser, adminPassword, project, policy_id, contract, region):
    """Summary
...
def list_ipsec_site_connections(adminUser, adminPassword, project, contract, region):
    """Summary
...
def show_ipsec_site_connection_detail(adminUser, adminPassword, project, connectionid, contract, region):
    """Summary
    ...
    # conversion of object names to ids
    k5token = get_project_scoped_token(
        adminUser, adminPassword, project, connectionid, contract, region)
    connectorURL = 'https://networking.' + region + \
...
def create_ipsec_site_connections(adminUser, adminPassword, project, contract, region):
    """Summary
...
def update_ipsec_site_connections(adminUser, adminPassword, project, contract, region):
    """Summary
...
def delete_ipsec_site_connection(adminUser, adminPassword, project, connectionid, contract, region):
    """Summary
...
def list_vpn_services(adminUser, adminPassword, project, contract, region):
    """Summary
...
def show_vpn_service(adminUser, adminPassword, project, contract, region):
    """Summary
    ...
    # conversion of object names to ids
    k5token = get_project_scoped_token(
        adminUser, adminPassword, project, serviceid, contract, region)
    connectorURL = 'https://networking.' + region + \
...
def create_vpn_service(adminUser, adminPassword, project, contract, region):
    """Summary
...
def update_vpn_service(adminUser, adminPassword, project, serviceid, contract, region):
    """Summary
...
def delete_vpn_service(adminUser, adminPassword, project, serviceid, contract, region):
    """Summary
...
def list_ike_policies(adminUser, adminPassword, project, contract, region):
    """Summary
...
def show_ike_policy(adminUser, adminPassword, project, policyid, contract, region):
    """Summary
...
def delete_ike_policy(adminUser, adminPassword, project, policyid, contract, region):
    """Summary
...
def create_ike_policies(adminUser, adminPassword, project, contract, region):
    """Summary
...
def update_ike_policies(adminUser, adminPassword, project, contract, region):
    """Summary
    ...
    # conversion of object names to ids
    k5token = get_project_scoped_token(
        adminUser, adminPassword, project, policyid, contract, region)
    connectorURL = 'https://networking.' + region + \
        '.cloud.global.fujitsu.com/v2.0/vpn/ikepolicies/' + policyid
    response = requests.put(connectorURL,
                            headers={
...
def delete_heat_stack(stack_name):
    """Summary
